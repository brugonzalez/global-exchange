    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_moneda', models.CharField(choices=[('FIAT', 'Moneda Fiat'), ('DIGITAL', 'Moneda Digital'), ('CRYPTO', 'Criptomoneda')], default='FIAT', max_length=20)),
                ('esta_activa', models.BooleanField(default=True)),
                ('es_moneda_base', models.BooleanField(default=False, help_text='Moneda base para cálculos (solo una puede ser base)')),
                ('es_moneda_empresa', models.BooleanField(default=False, help_text='Moneda digital propia de la empresa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tasa_compra', models.DecimalField(decimal_places=8, max_digits=20)),
                ('tasa_venta', models.DecimalField(decimal_places=8, max_digits=20)),
                ('marca_de_tiempo', models.DateTimeField(default=django.utils.timezone.now)),
                ('volumen', models.DecimalField(decimal_places=8, default=Decimal('0.00'), help_text='Volumen de transacciones en este período', max_digits=20)),
                ('moneda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial_tasa', to='divisas.moneda')),
                ('moneda_base', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historial_tasa_base', to='divisas.moneda')),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['moneda', 'marca_de_tiempo'], name='divisas_his_moneda__32e822_idx'), models.Index(fields=['marca_de_tiempo'], name='divisas_his_marca_d_420f4e_idx')],
            },
        ),
        migrations.CreateModel(
            name='TasaCambio',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tasa_compra', models.DecimalField(decimal_places=8, help_text='Tasa de compra (precio al que compramos la moneda)', max_digits=20)),
                ('tasa_venta', models.DecimalField(decimal_places=8, help_text='Tasa de venta (precio al que vendemos la moneda)', max_digits=20)),
                ('diferencial', models.DecimalField(decimal_places=4, help_text='Diferencial entre compra y venta', max_digits=10)),
                ('fuente', models.CharField(choices=[('API', 'API Externa'), ('MANUAL', 'Ingreso Manual'), ('CALCULADO', 'Calculado')], default='API', max_length=20)),
                ('esta_activa', models.BooleanField(default=True)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
                ('valida_hasta', models.DateTimeField(blank=True, help_text='Fecha hasta la cual es válida esta tasa', null=True)),
